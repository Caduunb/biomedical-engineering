**********************************************
* ECGLab - last updated on Nov 27th, 2008    *
**********************************************
...
THIS SOFTWARE REQUIRES MATLAB 6.0 (OR NEWER).
Might not work properly with older versions of Matlab.
Please report any bugs, typos or translation errors to joaoluiz@gmail.com
...
- please note that ecgconvert will not work properly on x64 Windows.
  All other modules should work fine on any version of Windows.
...
- Press "Display Statistics" for a quantitative time-frequency
  ...
  The statistics are displayed no a new window and also on the command prompt.
- Patient Record can be edited/viewed in this module too.
